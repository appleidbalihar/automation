...
class WordExtractor(BaseExtractor):
    ...
    def _extract_images_from_docx(self, doc, image_folder):
        # Image URLs would embed http://127.0.0.1:5001/... (internal Dify API, inaccessible to
        # external RAG consumers). Returning empty map matches PDF text-only behaviour.
        return {}
